...
export FASTLANE_MAC_PASSWORD=''#mac开机密码 🚀
export FASTLANE_APPLEID=''#提供需要添加udid的账号 🚀
#关闭双重认证 需要手动添加 APP-SPECIFIC和session cookie 🚀
export FASTLANE_APPLE_APPLICATION_SPECIFIC_PASSWORD=''#进入苹果官网生成的特殊密码APP-SPECIFIC https://appleid.apple.com/account/manage 🚀
export FASTLANE_SESSION=''#执行fastlane spaceauth -u user@email.com，生成session cookie 🚀
